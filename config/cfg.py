...
class BaseConfig(object):
    ...
    def __init__(self):
        ...
        self.parser.add_argument('--save_folder', default='/Share8/zbf/AFLL/result/save_model/checkpoint_catar/', help='Path to save checkpoint models')
        self.parser.add_argument('--save_log', default='/Share8/zbf/AFLL/result/save_log/logs_catar/',help='Path to save checkpoint models')
        ...
        self.parser.add_argument('--img_root', default='/Share8/zbf/AFLL/img_root/', type=str, help='Image root')
        self.parser.add_argument('--data_root', default='/Share8/zbf/AFLL/data/')
        ...
        self.parser.add_argument('--lamada', default=100, type=float, help='all loss function weight')
        self.parser.add_argument('--beta', default=1, type=float, help='CJH loss function weight')
    ...
    def initialize(self, fixed=None, print_cfg=True):
        ...
        if self.args.debug:
            self.args.save_log = '/Share8/zbf/AFLL/result/DEBUG_logs/'
            self.args.save_folder = '/Share8/zbf/AFLL/result/DEBUG_models/'
